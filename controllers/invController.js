...
invCont.buildDeleteInventoryView = async function(req, res, next) {
  ...
  res.render('inventory/deleteConfirm', {
    ...
    nav,
    errors: null,
    inv_id: itemData[0].inv_id,        // ← FIXED: Added [0]
    inv_make: itemData[0].inv_make,    // ← FIXED: Added [0]
    inv_model: itemData[0].inv_model,  // ← FIXED: Added [0]
    inv_year: itemData[0].inv_year,    // ← FIXED: Added [0]
    inv_price: itemData[0].inv_price,  // ← FIXED: Added [0]
...
invCont.deleteInventory = async function (req, res, next) {
  let nav = await utilities.getNav();
  const inv_id = parseInt(req.body.inv_id)  // Get from req.body, not params
  const { inv_make, inv_model } = req.body  // Get make and model from body
